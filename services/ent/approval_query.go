...
type ApprovalQuery struct {
	...
	withVariant *CreativeVariantQuery
...
func (_q *ApprovalQuery) QueryVariant() *CreativeVariantQuery {
...
func (_q *ApprovalQuery) WithVariant(opts ...func(*CreativeVariantQuery)) *ApprovalQuery {
	query := (&CreativeVariantClient{config: _q.config}).Query()
...
//		GroupBy(approval.FieldOrganizationID).
//		Aggregate(ent.Count()).
//		Scan(ctx, &v)
...
//
//	client.Approval.Query().
//		Select(approval.FieldOrganizationID).
//		Scan(ctx, &v)
...
func (_q *ApprovalQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Approval, error) {
	...
	if query := _q.withVariant; query != nil {
		if err := _q.loadVariant(ctx, query, nodes, nil,
			func(n *Approval, e *CreativeVariant) { n.Edges.Variant = e }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (_q *ApprovalQuery) loadVariant(ctx context.Context, query *CreativeVariantQuery, nodes []*Approval, init func(*Approval), assign func(*Approval, *CreativeVariant)) error {
	...
	query.Where(creativevariant.IDIn(ids...))
...
func (_q *ApprovalQuery) querySpec() *sqlgraph.QuerySpec {
	...
	if fields := _q.ctx.Fields; len(fields) > 0 {
		...
		if _q.withVariant != nil {
			_spec.Node.AddColumnOnce(approval.FieldVariantID)
		}
	}
